...
// db= https://obscure-journey-31985.herokuapp.com
// http://localhost:5000
...
app.get("/", async (req, res) => {
  res.send("server is running wooooooow!");
});

// CONNECTION URI
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.rexnv.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
